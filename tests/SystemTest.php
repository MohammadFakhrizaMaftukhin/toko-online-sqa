...
use Facebook\WebDriver\WebDriverExpectedCondition; // 1. Wajib tambahkan ini
...
class SystemTest extends TestCase{
    ...
    public function testHomepageAndSearchFeature(){
        ...
        $searchBox->submit(); // Meminta browser melakukan refresh

        // 2. PENYELESAIAN MASALAH (EXPLICIT WAIT)
        // Paksa driver menunggu (maksimal 5 detik) hingga URL berubah
        $this->driver->wait(5)->until(
            WebDriverExpectedCondition::urlContains('cari=Kemeja')
        );

        // 3. Setelah URL berubah, DOM dipastikan sudah baru dan aman untuk dicari ulang
